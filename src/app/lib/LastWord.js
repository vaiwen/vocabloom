...
const LastWord = () => {
  return (
    <>
        <div className={`${style? '' : 'border-2 border-[#eee] p-2' } mb-2 rounded-lg flex justify-between items-center cursor-pointer transition-all duration-300 hover:border-blue-600`}>
        ...
        <button onClick={handleRemove} className='w-full p-1 text-white bg-red-500 font-semibold text-sm rounded-md transition-all duration-300 hover:bg-red-600'>Delete</button>
    </>
  )
}
